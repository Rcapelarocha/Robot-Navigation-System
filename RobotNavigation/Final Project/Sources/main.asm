...
;*                                                                          *
;* This program controls the eebot mobile robot using a navigation system   *
;* which allows the bot to find it’s way through a maze.                    *
;*                                                                          *
;* Date: August 17, 2023                                                    *
;* Authors: Amyn Jiwani, Rafael Capela-Rocha, Moaz Hameed, Keeran Cheliyan  *
;****************************************************************************
...
PTH_A_INT      EQU $CD    ; Minimum sensor detection value for A
PTH_B_INT      EQU $CD    ; Minimum sensor detection value for B        
PTH_C_INT      EQU $CD    ; Minimum sensor detection value for C
PTH_D_INT      EQU $CD    ; Minimum sensor detection value for D

PTH_E_INT      EQU $85   ; Differential E-F value where SENSOR_LINE < PTH_E_INT (robot must move right)
PTH_F_INT      EQU $86   ; Differential E-F value where SENSOR_LINE > PTH_F_INT (robot must move left)

  ; Displacement values 
INC_DIS        EQU 200   ; INCREMENT distance
...
UTRN_DIS       EQU 10800 ; U-TURN distance
...
NOT_FORWARD:   CMPA  #RT_TRN                   
               BNE   NOT_RT_TRN 
               LDY   #1000                      ; 20 ms delay to allow the for the turns
               JSR   del_50us               
               JSR   RT_TRN_ST                 
               RTS                             
;------------------------------------------------------------------------------------------
NOT_RT_TRN:    CMPA  #LT_TRN                   
               BNE   NOT_LT_TRN 
               LDY   #1000                      ; 20 ms delay to allow for the turns
               JSR   del_50us               
               JSR   LT_TRN_ST                 
               RTS                             
;------------------------------------------------------------------------------------------
